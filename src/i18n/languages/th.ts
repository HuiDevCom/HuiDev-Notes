...
export const th: Translation = {
	...
	[Key.passport]: "พาสปอร์ต",
	[Key.passportProfile]: "โปรไฟล์",
	[Key.passportProfileBanner]: "จัดการโปรไฟล์และความปลอดภัยพาสปอร์ตของคุณ",
	[Key.passportFieldName]: "ชื่อ",
	[Key.passportFieldNickname]: "ชื่อเล่น",
	[Key.passportFieldWebsite]: "เว็บไซต์",
	[Key.passportFieldUsername]: "ชื่อผู้ใช้",
	[Key.passportFieldAvatar]: "URL รูปโปรไฟล์",
	[Key.passportSaveProfile]: "บันทึกการเปลี่ยนแปลง",
	[Key.passportProfileSaved]: "บันทึกโปรไฟล์แล้ว",
	[Key.passportNoChanges]: "ไม่มีการเปลี่ยนแปลงที่จะบันทึก",
	[Key.passportActionFailed]: "การดำเนินการล้มเหลว",
	[Key.passportNeedSignIn]: "เข้าสู่ระบบเพื่อจัดการโปรไฟล์ของคุณ",
	[Key.passportProfileUnavailable]: "ไม่สามารถโหลดข้อมูลบัญชี",
	[Key.passportBanner]: "เข้าสู่ระบบด้วยพาสปอร์ตเพื่อจัดการข้อมูลประจำตัวและโปรไฟล์ของคุณ",
	[Key.passportSignIn]: "เข้าสู่ระบบ / ลงทะเบียน",
	[Key.passportAccount]: "โปรไฟล์และความปลอดภัย",
	[Key.passportSignOut]: "ออกจากระบบ",
	[Key.passportNotSignedIn]:
		"คุณยังไม่ได้เข้าสู่ระบบ — เข้าสู่ระบบเพื่อซิงก์ข้อมูลประจำตัวพาสปอร์ตของคุณ",
	[Key.passportAnonymous]: "ผู้ใช้พาสปอร์ต",
	[Key.passportCallback]: "กำลังดำเนินการเข้าสู่ระบบให้เสร็จ โปรดรอสักครู่…",
	[Key.passportCallbackFailed]: "การดำเนินการเข้าสู่ระบบล้มเหลว",
	[Key.passportBack]: "กลับไปที่พาสปอร์ต",
