...
export const zh_CN: Translation = {
	...
	[Key.passport]: "风绘通行证",
	[Key.passportProfile]: "个人资料",
	[Key.passportProfileBanner]: "管理你的通行证资料与安全设置。",
	[Key.passportFieldName]: "姓名",
	[Key.passportFieldNickname]: "昵称",
	[Key.passportFieldWebsite]: "网站",
	[Key.passportFieldUsername]: "用户名",
	[Key.passportFieldAvatar]: "头像链接",
	[Key.passportSaveProfile]: "保存资料",
	[Key.passportProfileSaved]: "资料已保存",
	[Key.passportNoChanges]: "没有需要保存的更改",
	[Key.passportActionFailed]: "操作失败",
	[Key.passportNeedSignIn]: "请先登录后再管理个人信息。",
	[Key.passportProfileUnavailable]: "无法读取账户信息",
	[Key.passportBanner]: "使用风绘通行证登录，管理你的身份与资料。",
	[Key.passportSignIn]: "登录 / 注册",
	[Key.passportAccount]: "个人信息与安全",
	[Key.passportSignOut]: "退出登录",
	[Key.passportNotSignedIn]: "尚未登录 —— 登录后即可同步你的通行证身份。",
	[Key.passportAnonymous]: "通行证用户",
	[Key.passportCallback]: "正在完成登录，请稍候……",
	[Key.passportCallbackFailed]: "登录回调处理失败",
	[Key.passportBack]: "返回通行证",
