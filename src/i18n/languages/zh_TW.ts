...
export const zh_TW: Translation = {
	...
	[Key.passport]: "風繪通行證",
	[Key.passportProfile]: "個人資料",
	[Key.passportProfileBanner]: "管理你的通行證資料與安全設定。",
	[Key.passportFieldName]: "姓名",
	[Key.passportFieldNickname]: "暱稱",
	[Key.passportFieldWebsite]: "網站",
	[Key.passportFieldUsername]: "使用者名稱",
	[Key.passportFieldAvatar]: "頭像連結",
	[Key.passportSaveProfile]: "儲存資料",
	[Key.passportProfileSaved]: "資料已儲存",
	[Key.passportNoChanges]: "沒有需要儲存的變更",
	[Key.passportActionFailed]: "操作失敗",
	[Key.passportNeedSignIn]: "請先登入後再管理個人資訊。",
	[Key.passportProfileUnavailable]: "無法讀取帳戶資訊",
	[Key.passportBanner]: "使用風繪通行證登入，管理你的身分與資料。",
	[Key.passportSignIn]: "登入 / 註冊",
	[Key.passportAccount]: "個人資訊與安全",
	[Key.passportSignOut]: "登出",
	[Key.passportNotSignedIn]: "尚未登入 —— 登入後即可同步你的通行證身分。",
	[Key.passportAnonymous]: "通行證使用者",
	[Key.passportCallback]: "正在完成登入，請稍候……",
	[Key.passportCallbackFailed]: "登入回呼處理失敗",
	[Key.passportBack]: "返回通行證",
